...
function Facebook() {
  return (
    <svg className="w-8 h-8 fill-current text-cool-gray transition ease-in-out duration-300 transform hover:scale-90" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
function Tiktok() {
  return (
    <svg className="w-8 h-8 fill-current text-cool-gray transition ease-in-out duration-300 transform hover:scale-90" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
